...
- primitive expressions, which reperesent the simplest entitiest the language is concerned with
- means on combination, by which compound elements are built from simpler ones, and
