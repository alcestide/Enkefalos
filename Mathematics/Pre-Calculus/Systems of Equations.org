...
:PROPERTIES:
:CUSTOM_ID: example-1---substitution-method
:END:
\[ 
\left \{ 
\begin{aligned}
...
:PROPERTIES:
:CUSTOM_ID: example-3---graphical-method
:END:
\[
\left \{ 
\begin{aligned}
...
:PROPERTIES:
:CUSTOM_ID: number-of-solutions-of-a-linear-system-in-two-variables
:END:
...
:PROPERTIES:
:CUSTOM_ID: guidelines-for-modeling-with-systems-of-equations
:END:
...
:PROPERTIES:
:CUSTOM_ID: solving-a-linear-system
:END:
The following are two examples of systems of linear equations in *three*
variables. The\\
second system is in *triangular form*; that is, the variable x doesn't
...
:PROPERTIES:
:CUSTOM_ID: example-1---solving-a-triangular-system-using-back-substitution
:END:
\[
\left \{ 
\begin{aligned}
...
:PROPERTIES:
:CUSTOM_ID: example-2---solving-a-system-of-three-equations-in-three-variables
:END:
...
:PROPERTIES:
:CUSTOM_ID: the-number-of-solutions-of-a-linear-system
:END:
...
:PROPERTIES:
:CUSTOM_ID: matrices-and-systems-of-linear-equations
:END:
...
:PROPERTIES:
:CUSTOM_ID: definition-of-matrix
:END:
...
:PROPERTIES:
:CUSTOM_ID: the-augmented-matrix-of-a-linear-system
:END:
